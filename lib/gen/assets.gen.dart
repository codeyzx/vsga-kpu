...
class $AssetsFontsGen {
  ...
  /// List of all assets
  List<String> get values => [poppinsBold, poppinsBoldItalic, poppinsItalic, poppinsMedium];
}
...
class $AssetsIconsGen {
  ...
  AssetGenImage get circleBottomLeft => const AssetGenImage('assets/icons/circle_bottom_left.png');

  /// File path: assets/icons/circle_bottom_right.png
  AssetGenImage get circleBottomRight => const AssetGenImage('assets/icons/circle_bottom_right.png');

  /// File path: assets/icons/circle_top_left.png
  AssetGenImage get circleTopLeft => const AssetGenImage('assets/icons/circle_top_left.png');

  /// File path: assets/icons/circle_top_right.png
  AssetGenImage get circleTopRight => const AssetGenImage('assets/icons/circle_top_right.png');

  /// File path: assets/icons/kpu_logo.svg
  SvgGenImage get kpuLogo => const SvgGenImage('assets/icons/kpu_logo.svg');

  /// List of all assets
  List<dynamic> get values => [circleBottomLeft, circleBottomRight, circleTopLeft, circleTopRight, kpuLogo];
}
